...
class NavigationComponent extends PureComponent<void, NCProps, void> {
  render() {
    ...
    const bnProps = {
      labelFontFamily: bnOptions.labelFontFamily,
      labelFontSize: bnOptions.labelFontSize,
      ...
      >
        {navigationState.routes.map((route, index) => {
          ...
          const tabProps = {
            ...
            labelFontFamily: tabOptions.labelFontFamily,
            labelFontSize: tabOptions.labelFontSize,
