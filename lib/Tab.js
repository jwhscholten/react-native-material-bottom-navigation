...
export default class Tab extends Component {
  ...
  _renderLabel = () => {
    const { active, labelColor, activeLabelColor, labelFontFamily, labelFontSize, label } = this.props
    return (
      <Animated.Text
        style={[
          { color: active && activeLabelColor ? activeLabelColor : labelColor, fontFamily: labelFontFamily, fontSize: labelFontSize },
          styles.label,
